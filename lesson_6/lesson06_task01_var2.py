...
print(f'Четные цифры в числе {num_copy}: {even[::-1]}')
print(f'Нечетные цифры в числе {num_copy}: {uneven[::-1]}')
...
"""
Введите число: 12
Четные цифры в числе 12: [2]
Нечетные цифры в числе 12: [1]
3.9.0 (tags/v3.9.0:9cf6752, Oct  5 2020, 15:34:40) [MSC v.1927 64 bit (AMD64)] win32
 ...
 type= <class 'list'>, size= 88, object= [2]
	 type= <class 'int'>, size= 28, object= 2
 type= <class 'list'>, size= 88, object= [1]
	 type= <class 'int'>, size= 28, object= 1
"""

"""
Введите число: 1234567890
Четные цифры в числе 1234567890: [2, 4, 6, 8, 0]
Нечетные цифры в числе 1234567890: [1, 3, 5, 7, 9]
3.9.0 (tags/v3.9.0:9cf6752, Oct  5 2020, 15:34:40) [MSC v.1927 64 bit (AMD64)] win32
 type= <class 'int'>, size= 24, object= 0
 type= <class 'int'>, size= 32, object= 1234567890
 type= <class 'int'>, size= 28, object= 1
 type= <class 'list'>, size= 120, object= [0, 8, 6, 4, 2]
	 type= <class 'int'>, size= 24, object= 0
	 type= <class 'int'>, size= 28, object= 8
	 type= <class 'int'>, size= 28, object= 6
	 type= <class 'int'>, size= 28, object= 4
	 type= <class 'int'>, size= 28, object= 2
 type= <class 'list'>, size= 120, object= [9, 7, 5, 3, 1]
...
Четные цифры в числе 13566192643362838763189695118785125752177375262366: [6, 6, 2, 6, 4, 6, 2, 8, 8, 6, 8, 6, 8, 8, 2, 2, 2, 6, 2, 6, 6]
Нечетные цифры в числе 13566192643362838763189695118785125752177375262366: [1, 3, 5, 1, 9, 3, 3, 3, 7, 3, 1, 9, 9, 5, 1, 1, 7, 5, 1, 5, 7, 5, 1, 7, 7, 3, 7, 5, 3]
3.9.0 (tags/v3.9.0:9cf6752, Oct  5 2020, 15:34:40) [MSC v.1927 64 bit (AMD64)] win32
 type= <class 'int'>, size= 24, object= 0
 type= <class 'int'>, size= 48, object= 13566192643362838763189695118785125752177375262366
 type= <class 'int'>, size= 28, object= 1
 type= <class 'list'>, size= 248, object= [6, 6, 2, 6, 2, 2, 2, 8, 8, 6, 8, 6, 8, 8, 2, 6, 4, 6, 2, 6, 6]
	 type= <class 'int'>, size= 28, object= 6
	 type= <class 'int'>, size= 28, object= 6
	 type= <class 'int'>, size= 28, object= 2
	 type= <class 'int'>, size= 28, object= 6
	 ...
	 type= <class 'int'>, size= 28, object= 6
	 type= <class 'int'>, size= 28, object= 6
 type= <class 'list'>, size= 312, object= [3, 5, 7, 3, 7, 7, 1, 5, 7, 5, 1, 5, 7, 1, 1, 5, 9, 9, 1, 3, 7, 3, 3, 3, 9, 1, 5, 3, 1]
	 type= <class 'int'>, size= 28, object= 3
	 type= <class 'int'>, size= 28, object= 5
	 type= <class 'int'>, size= 28, object= 7
	 type= <class 'int'>, size= 28, object= 3
